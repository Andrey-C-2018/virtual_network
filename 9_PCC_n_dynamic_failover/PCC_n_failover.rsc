# 2025-09-06 15:25:21 by RouterOS 7.19.2
...
set [ find default-name=ether1 ] disable-running-check=no name=ether_forWinbox

/interface lte set [ find default-name=lte1 ] name=lte_WAN2
...
/ip pool add name=dhcp_pool0 ranges=172.16.1.2-172.16.1.100
/ip dhcp-server
...
/ip dhcp-client
add add-default-route=no interface=ether_forWinbox use-peer-dns=no use-peer-ntp=no
...
/ip firewall nat
add action=masquerade chain=srcnat routing-mark=to_ISP1
add action=masquerade chain=srcnat routing-mark=to_ISP2

/ip route
add dst-address=8.8.8.8 gateway=192.168.1.1 scope=10
add dst-address=1.1.1.1 gateway=192.168.8.1 scope=10
add distance=1 dst-address=0.0.0.0/0 gateway=8.8.8.8 target-scope=11
add distance=2 dst-address=0.0.0.0/0 gateway=1.1.1.1 target-scope=11
add distance=1 dst-address=0.0.0.0/0 gateway=8.8.8.8 routing-table=to_ISP1 target-scope=11
add distance=1 dst-address=0.0.0.0/0 gateway=1.1.1.1 routing-table=to_ISP2 target-scope=11
